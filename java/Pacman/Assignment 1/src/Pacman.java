...
public class Pacman extends JFrame {
	...
	private void makeLevel(GameContext context) {
		Player p = new Player(context, 5, 3);
	...
	private class PacmanDisplay extends JPanel {
		...
		public void paint(Graphics g) {
			...
			g.drawLine(1, 1, 1, context.getH() - 1);
			g.drawLine(1, 1, context.getW() - 1, 1);
			g.drawLine(context.getW() - 1, 1, context.getW() - 1, context.getH() - 1);
			g.drawLine(1, context.getH() - 1, context.getW() - 1, context.getH() - 1);
