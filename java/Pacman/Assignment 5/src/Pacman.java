...
public class Pacman extends JFrame {
	...
	private void makeLevel(GameContext context) {
		...
		context.getEntities().addEntity(new Ghost(context, 1, 1));
		context.getEntities().addEntity(new Ghost(context, 8, 8));
		...
		for (int i = 1; i <= 18; i++) {
			context.getEntities().addEntity(new Pellet(context, i, 2, i % 2 == 0));
			context.getEntities().addEntity(new Pellet(context, i, 7, i % 2 == 0));
		}
