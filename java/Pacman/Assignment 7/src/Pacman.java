...
public class Pacman extends JFrame {
	...
	private void newGame(File file) {
		int highScore = context == null ? 0 : context.getHighScore();
		currentFile = file;
		...
		// Resize Frame
		setSize(context.getW(), context.getH() + 44 + 24);
	...
	private void render() {
		display.validate();
		display.repaint();
		score.setText(Integer.toString(context.getScore()));
		highScore.setText(Integer.toString(context.getHighScore()));
	}
