public class ConstructString {
	...
	private String genImagesHTML(String img) {
		...
		_images = "\t\t<p class=\"title\"><strong>Picture</strong></p>\n";
	...
	private String writeStart() {
		...
		start += "\t\t\t}\n";
		start += "\t\t}\n";
		start += "\t\tfunction correctDim() {\n";	
		start += "\t\t\tvar d = document.getElementById('bb');\n";
		start += "\t\t\tvar y = Math.ceil(d.offsetHeight/177);\n";
		start += "\t\t\td.style.height = y*177 + 'px';\n";
		start += "\t\t}\n";
		start += "\t</script>\n";
		start += "\t<style>\n";
		start += "\t\tdiv.head {\n";
		start += "\t\t\tbackground-image: url('http://i1348.photobucket.com/albums/p731/tkhunlertkit/Frame/Framehead_zpsdf4213ff.png');\n";
		start += "\t\t\tbackground-position: center top;\n";
		start += "\t\t\theight: 275px;\n";
		start += "\t\t\tbackground-repeat: no-repeat;\n";
		start += "\t\t\tmargin-bottom: 0;\n";
		start += "\t\t\tpadding-bottom: 0;\n";
		start += "\t\t\tborder-bottom: 0;\n";
		start += "\t\t\tborder-spacing: 0;\n";
		start += "\t\t\tborder-collapse: collapse;\n";
		start += "\t\t\tborder: 1px solid transparent;\n";
		start += "\t\t}\n";
		start += "\t\tdiv.body {\n";
		start += "\t\t\tbackground-image: url('http://i1348.photobucket.com/albums/p731/tkhunlertkit/Frame/FrameBody_zps22f3a1f8.png');\n";
		start += "\t\t\tbackground-position: center top;\n";
		start += "\t\t\tbackground-repeat: repeat-y;\n";
		...
		start += "\t\t}\n";
		start += "\t\tdiv.end {\n";
		start += "\t\t\tbackground-image: url('http://i1348.photobucket.com/albums/p731/tkhunlertkit/Frame/Framebottom_zpsd3c85ae1.png');\n";
		start += "\t\t\tbackground-position: center top;\n";
		start += "\t\t\tbackground-repeat: no-repeat;\n";
		start += "\t\t\theight: 280px;\n";
		start += "\t\t\tborder: 1px solid transparent;\n";
		...
		start += "\t</style>\n";		
		start += "</head>\n";
		start += "<body  onload=\"correctDim()\">\n";
		start += "\t<div class=\"head\"></div>\n";
		start += "\t<div id=\"bb\" class=\"body\">\n";
	...
	public String getAdded() {
		return _images + _product + _shipping + _payment;
	}
